...
public class ViewShotItemData {
	...
	private String m_nImgRes;
	    ...
	    public String getImageRes() { return m_nImgRes; }
	    public void setImageRes(String p) { m_nImgRes = p;}
